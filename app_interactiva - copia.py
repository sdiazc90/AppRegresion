...
# 1) Cargar datos, modelo y columnas
autos_limpios = pd.read_csv(r'C:\Users\nono_\RegresionAutos\autos_limpios.csv')

with open(r'C:\Users\nono_\RegresionAutos\mejor_modelo_xgb.pkl', 'rb') as f:
    modelo = pickle.load(f)

with open(r'C:\Users\nono_\RegresionAutos\columnas_modelo.pkl', 'rb') as f:
    columnas_modelo = pickle.load(f)

with open(r'C:\Users\nono_\RegresionAutos\scaler.pkl', 'rb') as f:
...
def predict():
    ...
    # filtrar sólo numéricas + marca/modelo seleccionados
    ...
    # 6) Extraer listas para JS/Plotly
...
def mostrar_importancias():
    ...
    return render_template('importancias.html',
